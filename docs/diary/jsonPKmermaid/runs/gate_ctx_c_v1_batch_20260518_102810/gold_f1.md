# gate_ctx_ab gold F1 — /Users/cyning/Desktop/Projects/ai-ink-brain-api-python/docs/diary/jsonPKmermaid/runs/gate_ctx_c_v1_batch_20260518_102810
...
| `CTX_DUAL_MD_T002_unified_sse_chain_contract_S0.jsonl` | `T002_unified_sse_chain_contract` | `CTX_DUAL_MD` | 1.000/0.833/0.909 | 0.364/0.667/0.471 |
| `CTX_V2_QUERY_T002_unified_sse_chain_contract_S0.jsonl` | `T002_unified_sse_chain_contract` | `CTX_V2_QUERY` | 0.857/1.000/0.923 | 0.667/1.000/0.800 |
| `CTX_DUAL_MD_T003_ingest_admin_rpc_S0.jsonl` | `T003_ingest_admin_rpc` | `CTX_DUAL_MD` | 1.000/0.833/0.909 | 0.375/0.500/0.429 |
| `CTX_V2_QUERY_T003_ingest_admin_rpc_S0.jsonl` | `T003_ingest_admin_rpc` | `CTX_V2_QUERY` | 0.857/1.000/0.923 | 0.750/1.000/0.857 |
...
| `T002_unified_sse_chain_contract` | `CTX_DUAL_MD` | 1 | 0.909 | 0.471 |
| `T002_unified_sse_chain_contract` | `CTX_V2_QUERY` | 1 | 0.923 | 0.800 |
| `T003_ingest_admin_rpc` | `CTX_DUAL_MD` | 1 | 0.909 | 0.429 |
| `T003_ingest_admin_rpc` | `CTX_V2_QUERY` | 1 | 0.923 | 0.857 |
