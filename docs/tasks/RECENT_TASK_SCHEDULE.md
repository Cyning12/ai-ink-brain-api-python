...
#### 1.7 G0 链 · 本体扫描与 `.ai.md` 退场（**CLOSE** · 2026-06-17）

> **串行 + 并行 NIT 均已关账** · Inform 图源单源（YAML → md / graph.json）· 0× `.ai.md`

| # | slug | task | 仓 | 状态 |
| --- | --- | --- | --- | --- |
| **1** | `ontology-inventory-scan-g0` | [`docs/harness/tasks/done/harness/task_ontology_inventory_scan_g0_v1.md`](../../harness/tasks/done/harness/task_ontology_inventory_scan_g0_v1.md) | 工作区 + cyning-harness | **done** |
| **2** | `graph-yaml-remove-ai-md` | [`done/task_engineering_graph_yaml_remove_ai_md_v1.md`](done/task_engineering_graph_yaml_remove_ai_md_v1.md) | Ink 后端 | **done** · PR #179 |
...
| 2026-06-17 | **§1.7 G0 NIT done**：`graph-yaml-subgraph-nit` 关账 · PR #180 merge · **G0 链 CLOSE** |
