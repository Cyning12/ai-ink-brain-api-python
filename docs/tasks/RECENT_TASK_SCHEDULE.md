...
#### 1.6 续 · Inform 闭环（串行 · **P0 done / P1 blocked_until_merge**）

> **执行顺序**：**P0 →（CI 绿 + merge）→ P1** · 各 task 独立 PR · **禁止 P0 未 merge 开 P1**  
> **P0 PR 状态**：已开 PR → 等 CI 绿 → merge 入 `main`（merge commit 待回填）

**P1 硬闸门**：P0 done + HG-REINSPECT + **P0 PR CI 全绿 + merge 入 `main`**

| # | slug | task | 分支 | 状态 |
| --- | --- | --- | --- | --- |
| **1** | `graph-yaml-doc-hygiene-p0` | [`done/task_engineering_graph_yaml_doc_hygiene_p0_v1.md`](done/task_engineering_graph_yaml_doc_hygiene_p0_v1.md) | `task/graph-yaml-doc-hygiene-p0` | **done** · HG-TASK-DRAFT **approved** · HG-REINSPECT **signed** · PR 待 merge |
