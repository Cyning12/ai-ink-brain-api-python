...
|------|-----|
| **task_slug** | `harness-invokes-by-task-prompts-sync` |
| **test_strategy** | `not_applicable`（文档 / prompts 路径，无 api 变更） |
| **semi_auto** | `true` |
...
- [ ] 维护者 rsync 至工作区 `Projects/docs/harness/prompts/`（若工作区为 prompts 单源）
- [ ] `TEMPLATE-requirements-invoke` 已为 by-task（无需改）
