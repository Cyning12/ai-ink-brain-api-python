# Coding Wiki · 日志（append-only）

| 日期 | 事件 |
|------|------|
| 2026-05-26 | **试点启动**：落盘 `CODING_WIKI.md`、`index.md`；schema 冻结 `CODING-WIKI-PILOT@2026-05-25` |
| 2026-05-26 | **ingest** 3× done task → `syntheses/`（`harness-p1-docs-consolidation`、`tech-graph-gate-d-v2-tasks`、`docs-tasks-reorg-move`） |
| 2026-05-26 | **入口**：`docs/README.md`、`docs/tasks/README.md` 各增一行链至本目录 |
...
| 2026-05-29 | **concept** · `task-schedule-ink-backend` · 排期 hub · 链 RECENT · `GOV-TASK-SCHEDULE-WIKI@2026-05-29` |
