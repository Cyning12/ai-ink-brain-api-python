...
- 文件：`docs/harness/prompts/10-requirements.md`、`docs/harness/prompts/TEMPLATE-requirements-invoke.md`
- 真值：Harness 评价回复 §3.3；`HANDOFF_SEMI_AUTO.md` §3.4（状态栏，本棒已 done）
