...
- docs/harness/prompts/TEMPLATE-requirements-invoke.md §3
...
你必须完成：
0. Invoke 快照：将本消息全文落盘 docs/harness/invokes/invoke_20260523_10_harness-p1-docs-consolidation.md（含元数据表），再开始实质输出。
