...
- docs/harness/prompts/HANDOFF_AUTO_COMMIT.md（本轮仅改排期/invoke 时按路径 commit）
...
- **本 invoke**：`ai-ink-brain-api-python/docs/harness/invokes/invoke_20260522_30_harness-stage0-1-pr-chore-branch.md`
