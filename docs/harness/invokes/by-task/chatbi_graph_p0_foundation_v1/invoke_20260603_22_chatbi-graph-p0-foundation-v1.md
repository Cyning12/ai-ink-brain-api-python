# Invoke 快照 · 22 任务审核 · chatbi_graph_p0_foundation_v1 · R1
...
| **freeze_id** | （task 无新 L1 SPEC · 引用 research/plan SPEC） |
| **date** | `20260603` |
...
- 待审 task 在 **`ai-ink-brain-api-python/docs/tasks/`** 下：`ai-ink-brain-api-python/docs/harness/reviews/task_chatbi_graph_p0_foundation_v1_audit_R1_20260603.md`（全文真值）；工作区 `docs/harness/reviews/` 可仅存指针链至此路径。  
- 否则：`docs/harness/reviews/task_chatbi_graph_p0_foundation_v1_audit_R1_20260603.md`
