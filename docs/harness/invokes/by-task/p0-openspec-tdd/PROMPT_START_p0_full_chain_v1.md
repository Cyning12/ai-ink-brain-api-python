# PROMPT START · P0 OpenSpec×TDD Loop 全链（R1 起）

> **落盘 invoke**：`invoke_YYYYMMDD_10_start_p0-openspec-tdd.md`（首次粘贴时）  
> **前置**：母单 `HG-LOOP-BATCH` = **approved**；分支 `task/harness-p0-openspec-tdd`
