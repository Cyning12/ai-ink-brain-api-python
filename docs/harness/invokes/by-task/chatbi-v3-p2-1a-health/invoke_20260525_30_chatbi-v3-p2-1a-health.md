...
- docs/harness/prompts/hats/30-execute-code.md（身份、拒开工、test_strategy: required）
- docs/harness/prompts/hats/40-self-check.md（命令证据、回填 ### 自检结论（执行者））
- docs/harness/prompts/handoff/HANDOFF_SEMI_AUTO.md（semi_auto 链式 40；human_gate 禁止静默代填）
