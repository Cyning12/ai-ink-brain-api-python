# Invoke Snapshot · 30 执行 · Wiki-CTX-AB P2
...
| 步骤 | 结果 |
| --- | --- |
| W 物化 | `wiki_ctx_ab_materialize_w.py` 确认 `payload_char_count=2096` |
| P2 对照 | Q1–Q4 × H-lean × W，8 条；仅载荷内作答 |
| 落盘 | `scorecard.md` §P2 · `conclusion_p2_zh.md` · task 回填 |
