# 启动 Prompt · 22 任务审核帽 · Wiki-CTX-AB P2（v1.0）

> **帽链（本会话计划）**：**22 → 30 → 40 → 50 → 关账**（各帽 **新对话** + 对应 `PROMPT_*`；**勿在本会话执行 30**）  
> **用法**：Open Folder **`ai-ink-brain-api-python/`** → **新对话** → **全文复制**下方代码块。  
> **task**：`docs/tasks/active/task_wiki_ctx_ab_v1.md` · `git_branch`: `task/wiki-ctx-ab-p2-v1`  
> **下一棒**：审查无阻塞后 → [`PROMPT_30_startup_wiki-ctx-ab-p2-v1.md`](./PROMPT_30_startup_wiki-ctx-ab-p2-v1.md)

| 后续帽 | 启动稿 |
|--------|--------|
| 30 | [`PROMPT_30_startup_wiki-ctx-ab-p2-v1.md`](./PROMPT_30_startup_wiki-ctx-ab-p2-v1.md) |
| 40 | [`PROMPT_40_startup_wiki-ctx-ab-p2-v1.md`](./PROMPT_40_startup_wiki-ctx-ab-p2-v1.md) |
| 50 | [`PROMPT_50_startup_wiki-ctx-ab-p2-v1.md`](./PROMPT_50_startup_wiki-ctx-ab-p2-v1.md) |
| 关账 | [`PROMPT_CLOSE_wiki-ctx-ab-p2-v1.md`](./PROMPT_CLOSE_wiki-ctx-ab-p2-v1.md) |
