...
| 步骤 | 文件 |
|------|------|
| **全链启动** | [`PROMPT_START_full_chain_v1.md`](./PROMPT_START_full_chain_v1.md) |
| **帽链模板** | [`PROMPT_TASK_22_to_CLOSE_v1.md`](./PROMPT_TASK_22_to_CLOSE_v1.md) |
...
| 日期 | 摘要 |
| --- | --- |
| 2026-05-27 | v1：单 task 全链 Prompt · 巩固 harness-task |
