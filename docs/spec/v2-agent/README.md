...
> **V2 文档验收归档（2026-05-11）**：Runner **L0–L7** 与 SPEC/任务索引见 **`../../tasks/done/task_chatbi_v2_docs_acceptance_archive_2026-05-11.md`**（**已迁入 done/**）；**V3 规划入口**见 **`../../tasks/active/task_chatbi_v3_planning_after_resume_v1.md`**；**V3 初版总规**见 **`../v3-agent/SPEC-ChatBI-V3-Overview.md`**（目录 **`../v3-agent/README.md`**）。
...
8. **`../v3-agent/SPEC-ChatBI-V3-Overview.md`** — **V3 总览（初版）**：生产级支柱、**`docs/tasks/active` 下 V3 任务归拢**、与 V2 / vNext 边界（**V2 里程碑已收口后可读**）
9. **SPEC-ChatBI-V2-Incremental-SSE-Timeline-vNext.md** — 下一版：执行期增量 SSE、Timeline/双栏（**在 V2 里程碑暂结之后**排期；可与 V3 支柱并行）  
10. **SPEC-ChatBI-V2-Incremental-SSE-Clarification-Brief-vNext.md** — vNext **吸收索引**（不明点已收口；**优先读 Timeline §0**）
...
- [V3 总览（初版）：生产级与任务归拢](../v3-agent/SPEC-ChatBI-V3-Overview.md)
