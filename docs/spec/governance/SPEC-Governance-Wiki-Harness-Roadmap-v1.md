...
| **T3** | Harness 全仓推广 | 工作区 `docs/harness/` + 前端 parity（P1-4） | **可开工** — [`task_harness_workspace_taxonomy_promote_v1.md`](../../tasks/active/task_harness_workspace_taxonomy_promote_v1.md) |
